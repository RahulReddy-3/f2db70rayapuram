...
router.get('/', function (req, res) { 
    res.render('index', { title: 'Vacuum Cleaner App', user : req.user }); 
}); 
 
router.get('/register', function(req, res) { 
    res.render('register', { title: 'Vacuum Cleaner App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'Vacuum Cleaner App Login', user : req.user }); 
}); 
